...
define('TUTORIAL_SESSION', 'Friday_04:30PM');
...
define('S3_BASE_URL','https://'.'aragavendhar-photo-album.s3.us-east-1.amazonaws.com/');
...
define('DB_ENDPOINT', 'aragavendhar-db.cc7i6xj0ixzq.us-east-1.rds.amazonaws.com');
// [ACTION REQUIRED] username of your RDS instance 
define('DB_USERNAME', 'arun');
// [ACTION REQUIRED] password of your RDS instance
define('DB_PWD', 'arunr2602');
...
define('DB_PHOTO_S3REFERENCE_COL_NAME', 'Reference_to_photo_object_in_S3');
?>